...
\begin{document}
    ...
    \begin{figure}[!h]
        \includegraphics[width=2\linewidth]{time_compare.png}
    \end{figure}
    ...
    \end{figure}
    \begin{figure}[!h]
        \includegraphics[width=1\linewidth]{app2.png}
    \end{figure}
    \newpage
    \begin{figure}[!h]
        \includegraphics[width=1\linewidth]{app3.png}
    \end{figure}
    ...
    \begin{enumerate}
        \item \textbf{Як можна отримувати дані з бази даних за допомогою SQL-запиту і відображати їх на сторінці за допомогою PHP та GD, або у тих мовах і засобах, які ви використали?}\\
            Для реалізації відображення даних з бази даних у Python можна використати бібліотеки \texttt{sqlite3}, \texttt{duckdb}, \texttt{matplotlib}, \texttt{plotly}, \texttt{pandas} та фреймворк \texttt{Streamlit}.
